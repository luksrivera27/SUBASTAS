...
export default function SectionVisUsua() {
    return (
                ...
                <div class="col d-flex">
                        ...
                        <div class="caja">                
                            <div id="carouselExampleControls" class="carousel slide mx-3" data-bs-ride="carousel">
                                <div class="carousel-inner">
                                    ...
                                    <img class="img" src={Fosil1}/>
                                    </div>
                                    <div class="carousel-item">
                                    <img class="img" src={Fosil2}/>
                                    </div>
                                    <div class="carousel-item">
                                    <img class="img" src={Fosil3}/>
                                    </div>
                                    <div class="carousel-item">
                                    <img class="img" src={Fosil4}/>
                                    </div>
                                </div>
                    ...
                    <div class="padrastro d-flex flex-column p-3 my-5 mx-2">
                        ...
                        <div class="fila3 d-flex">
                            <table class="table justify-content-evenly" striped bordered hover size="sm" HorizontalAlign="Center">
                                <thead>
                                    <tr>
                                    <th>N°</th>
                                    <th>Nombre</th>
