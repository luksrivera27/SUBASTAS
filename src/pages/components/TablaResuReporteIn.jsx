...
export default function TablaResuReporteIn() {
    return (
        <div>
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <td class="Ver detalle"><a type="button" class="btn btn-primary " href ={"/visualizacionsubasta"}>Ver</a></td>
                    ...
                    <td class ="fecha inicio">01/10/2021</td>
                    <td class ="Tipo de usuario">Usuario interno</td>        
                    <td class="Verdetalle"><a type="button" class="btn btn-primary " href ={"/frontadmi"}>Ver</a></td>
